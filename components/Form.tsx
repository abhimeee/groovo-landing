...
const Form = () => {
  ...
  return (
    <form onSubmit={onSubmit}>
      <div className="relative">
        <div className="min-w-0 flex-1">
          ...
          <input
            ...
            className="form-control block w-full rounded-sm bg-gray px-4 py-5 text-lg sm:text-xl text-black placeholder-gray-500 focus:outline-none"
            value={mail}
        ...
        <div className="mt-1 ml-2 sm:mt-3 sm:ml-3 flex-1 sm:flex-auto w-full sm:w-auto">
          <button
            type="submit"
            className="relative sm:absolute right-2 sm:top-2 w-full sm:w-auto block rounded-sm bg-activeButton py-3 px-6 text-lg sm:text-xl font-medium text-white shadow hover:bg-activeButton disabled:cursor-not-allowed"
      ...
      <span className="text-base sm:text-lg px-2 italic text-red-500">{message}</span>
    </form>
  );
};
