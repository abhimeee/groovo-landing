  ...
  return (
    <section className="xl:flex-row flex-col flex items-center justify-center gap-7 sm:gap-14">
      <div className="xl:w-5/12 w-11/12 xl:my-40 mt-40 flex flex-col gap-6">
        <h1 className="font-heading min-w-[73%] sm:min-w-[300px] xl:min-w-[490px] xl:w-10/12 w-8/12 font-normal text-3xl sm:text-5xl xl:text-6xl text-black relative z-40">
          {title.text}
          {title.mark && (
